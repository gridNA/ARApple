...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="cameraApplyinginScene",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC21cameraApplyinginScene11AppDelegate")
...
SWIFT_CLASS("_TtC21cameraApplyinginScene14ViewController")
